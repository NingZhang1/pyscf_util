...
def get_spin_coupling_term(spintwo_list, A_loc, B_loc, J):
    ...
    if A_loc == B_loc:
        tmp[A_loc] = numpy.dot(_get_S_plus(spintwo_list[A_loc]), _get_S_minus(spintwo_list[A_loc]))
    else:
    ...
    tmp = _get_identity_matrix_list(spintwo_list)
    if A_loc == B_loc:
        tmp[A_loc] = numpy.dot(_get_S_minus(spintwo_list[A_loc]), _get_S_plus(spintwo_list[A_loc]))
    else:
    ...
    tmp = _get_identity_matrix_list(spintwo_list)
    if A_loc == B_loc:
        tmp[A_loc] = numpy.dot(_get_Sz(spintwo_list[A_loc]), _get_Sz(spintwo_list[A_loc]))
    else:
